...
public abstract class AbstractGRASP<E> {
	...
	protected Double alpha;
        ...
        /**
         * The time limit the solver can run.
         */
	...
	public abstract Solution<E> localSearch();
        ...
        protected abstract Double chooseAlpha();
	 ...
	 */
	public AbstractGRASP(Evaluator<E> objFunction, Double alpha, Integer iterations, Long timeLimit) {
	 ...
	 */
	public Solution<E> solveLimitedByIterations() {
        ...
        public Solution<E> solveLimitedByTime() {
