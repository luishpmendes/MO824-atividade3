...
public class QBFAC implements Evaluator<Integer> {
	...
	public Double evaluateQBFAC() {
		...
		for (int i = 0; i < size; i++) {
                        //if(i>0 && variables[i]==1 && variables[i-1]==1)
                        //    return 0.0;
	...
	private Double evaluateContributionQBFAC(int i) {
		...
		for (int j = 0; j < size; j++) {
                        //if(j>0 && variables[j]==1 && variables[j-1]==1)
                        //        return 0.0;
			if (i != j)
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("x = " + Arrays.toString(qbf.variables));
		System.out.println("f(x) = " + qbf.evaluateQBFAC());
