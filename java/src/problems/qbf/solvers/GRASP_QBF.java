...
public class GRASP_QBF extends AbstractGRASP<Integer> {
	...
	public GRASP_QBF(Double alpha, Integer iterations, String filename) throws IOException {
		super(new QBF_Inverse(filename), alpha, iterations, (long)0);
	}
        
        public GRASP_QBF(Double alpha, Long timeLimit, String filename) throws IOException {
		super(new QBF_Inverse(filename), alpha, 0, timeLimit);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		Solution<Integer> bestSol = grasp.solveLimitedByIterations();
